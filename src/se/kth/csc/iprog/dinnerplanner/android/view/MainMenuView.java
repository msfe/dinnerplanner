...
public class MainMenuView {
    ...
    public MainMenuView(View view, DinnerModel model) {
        ...
        starterList = (LinearLayout) view.findViewById(R.id.startersScrollLinear);
        mainList = (LinearLayout) view.findViewById(R.id.mainsScrollLinear);
        desertList = (LinearLayout) view.findViewById(R.id.dessertsScrollLinear);
...
//        }
    ...
    public void addDishToScrollView(LinearLayout linearLayout, Dish dish){
    	...
    	LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(convertDpToPx(100), convertDpToPx(100));
